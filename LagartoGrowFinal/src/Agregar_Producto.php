    ...
    <div class="form-container">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($check !== false) {
                ...
                echo "<p style='color: red;'>El archivo no es una imagen.</p>";
                $uploadOk = 0;
            }
            ...
            if ($_FILES["imagen"]["size"] > 5000000) {
                echo "<p style='color: red;'>Lo siento, tu archivo es demasiado grande.</p>";
                $uploadOk = 0;
            }

            if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif") {
                echo "<p style='color: red;'>Lo siento, solo se permiten archivos JPG, JPEG, PNG y GIF.</p>";
                $uploadOk = 0;
            }
            ...
            if ($uploadOk == 1) {
                if (move_uploaded_file($_FILES["imagen"]["tmp_name"], $target_file)) {
                    ...
                    try {
                        ...
                        if ($conn->errno == 1062) {
                            echo "<p style='color: red;'>Error: Ya existe un producto con el código '$codigo'.</p>";
                        } else {
                            echo "<p style='color: red;'>Error inesperado: " . $e->getMessage() . "</p>";
                        }
                    }
                } else {
                    echo "<p style='color: red;'>Lo siento, hubo un error al subir tu archivo.</p>";
                }
            }
        }
